...
interval_predicted_collections = {
    '1m': Collections.MinuteIntervalPredictedData.value,
    '60m': Collections.HourIntervalPredictedData.value,
    '1d': Collections.DayIntervalPredictedData.value
}
